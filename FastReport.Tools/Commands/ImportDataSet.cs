...
namespace FastReport.DictionaryExtension.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ImportDataSet
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportDataSet"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private ImportDataSet(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static ImportDataSet Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in ImportDataSet's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new ImportDataSet(package, commandService);

            //_dte2 = await package.GetServiceAsync(typeof(DTE)) as EnvDTE80.DTE2;
        }
